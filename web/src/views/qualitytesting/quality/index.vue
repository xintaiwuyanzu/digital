<template>
    <section>
        <nac-info title="初检验收">
            ...
            <el-button type="primary" v-on:click="loadOne('down')" icon="el-icon-sort-down">下一件</el-button>
...
export default {
    ...
    methods: {
        ...
        back() {
            this.$router.push({path: '/qualitytesting',selectFond:this.$route.query.message.FondId})
        }
    }
}
</script>
