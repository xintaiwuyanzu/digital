			...
			switch( this.header.fieldArray[j].getDataType()) {
				...
				case 'C':
					if( objectArray[j] != null) {
						...
						dataOutput.write( Utils.textPadding( str_value, "GBK", this.header.fieldArray[j].getFieldLength()));
					}
					else {

						dataOutput.write( Utils.textPadding( "", "GBK", this.header.fieldArray[j].getFieldLength()));
					}
				...
				case 'D':
					if( objectArray[j] != null) {
						...
						dataOutput.write( Utils.textPadding( String.valueOf( calendar.get( Calendar.MONTH)+1), "GBK", 2, Utils.ALIGN_RIGHT, (byte)'0'));
						dataOutput.write( Utils.textPadding( String.valueOf( calendar.get( Calendar.DAY_OF_MONTH)), "GBK", 2, Utils.ALIGN_RIGHT, (byte)'0'));
					}
					else {
				...
				case 'F':
					...
					if( objectArray[j] != null) {
						...
						dataOutput.write( Utils.doubleFormating( (Double)objectArray[j], "GBK", this.header.fieldArray[j].getFieldLength(), this.header.fieldArray[j].getDecimalCount()));
					}
					else {

						dataOutput.write( Utils.textPadding( "?", "GBK", this.header.fieldArray[j].getFieldLength(), Utils.ALIGN_RIGHT));
					}
				...
				case 'N':
					...
					if( objectArray[j] != null) {
						...
						dataOutput.write(
							Utils.doubleFormating( (Double)objectArray[j], "GBK", this.header.fieldArray[j].getFieldLength(), this.header.fieldArray[j].getDecimalCount()));
					}
					else {

						dataOutput.write( 
							Utils.textPadding( "?", "GBK", this.header.fieldArray[j].getFieldLength(), Utils.ALIGN_RIGHT));
					}
