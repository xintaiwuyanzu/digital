...
public class DBFRow {
	 ...
	 */
	public boolean isDeleted() throws DBFException {
	 ...
	 */
	public BigDecimal getBigDecimal(String columnName) throws DBFException {
	 ...
	 * @return the data as BigDecimal
	 */
	public BigDecimal getBigDecimal(int columnIndex) throws DBFException {
		Object fieldValue = data[columnIndex];
		if (fieldValue == null) {
			return null;
		}
	 ...
	 */
	public boolean getBoolean(String columnName) throws DBFException {
	 ...
	 * @return the data as Boolean
	 */
	public boolean getBoolean(int columnIndex) throws DBFException {
		Object fieldValue = data[columnIndex];
		if (fieldValue == null) {
	...
	public byte[] getBytes(String columnName) throws DBFException {
	 ...
	 * @return the data as Boolean
	 */
	public byte[] getBytes(int columnIndex) throws DBFException {
		Object fieldValue = data[columnIndex];
		if (fieldValue == null) {
			return null;
		}
	...
	public Date getDate(String columnName) throws DBFException {
	 ...
	 * @return the data as Date
	 */
	public Date getDate(int columnIndex) throws DBFException {
		Object fieldValue = data[columnIndex];
		if (fieldValue == null) {
			return null;
		}
	...
	public double getDouble(String columnName) throws DBFException {
	 ...
	 * @return the data as Double
	 */
	public double getDouble(int columnIndex) throws DBFException {
		Object fieldValue = data[columnIndex];
		if (fieldValue == null) {
			return 0.0;
		}
	 ...
	 */
	public float getFloat(String columnName) throws DBFException {
	 ...
	 * @return the data as Float
	 */
	public float getFloat(int columnIndex) throws DBFException {
		Object fieldValue = data[columnIndex];
		if (fieldValue == null) {
			return 0.0f;
		}
	 ...
	 */
	public int getInt(String columnName) throws DBFException {
	 ...
	 * @return the data as int
	 */
	public int getInt(int columnIndex) throws DBFException {
		Object fieldValue = data[columnIndex];
		if (fieldValue == null) {
			return 0;
		}
	 ...
	 */
	public long getLong(String columnName) throws DBFException {
	 ...
	 * @return the data as long
	 */
	public long getLong(int columnIndex) throws DBFException {
		Object fieldValue = data[columnIndex];
		if (fieldValue == null) {
			return 0;
		}
